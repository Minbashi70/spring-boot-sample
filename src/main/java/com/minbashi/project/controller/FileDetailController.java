...
public class FileDetailController {
    ...
    public ResponseEntity<FileDetailResponse> getByFileDetail(@PathVariable String FileDetail) {
        return ResponseEntity.ok(fileDetailMapper.toResponse(fileDetailService.getByFileDetail(FileDetail)));
    }
